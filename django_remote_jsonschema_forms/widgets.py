...
class RemoteChoiceWidget(RemoteWidget):
    def as_dict(self):
        ...
        widget_dict['choices'] = [{'value': key, 'display': value} for key, value in self.widget.choices]
        return widget_dict
...
class RemoteMultiWidget(RemoteWidget):
    def as_dict(self):
        ...
        widget_dict['widgets'] = [RemoteWidget(widget).as_dict() for widget in self.widget.widgets]
        return widget_dict
